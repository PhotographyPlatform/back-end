...
beforeAll(async () => {
    ...
    await newUserCOll.create({username : 'sham', password : "s123", email:"moh@gmail.com"});
    await newUserCOll.create({ username: 'black angel', password: "s123", email: "moh@gmail.com" });
